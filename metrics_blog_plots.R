...
word_distances <- subset(word_distances, aligner %in% c('fave', 'maus', 'mfa_english', 'mfa_english_adapt', 'mfa_default_train', 
                                                        'mfa_english_ipa', 'mfa_english_ipa_adapt', 'mfa_ipa_train'))
phone_distances <- subset(phone_distances, aligner %in% c('fave', 'maus', 'mfa_english', 'mfa_english_adapt', 'mfa_default_train', 
                                                        'mfa_english_ipa', 'mfa_english_ipa_adapt', 'mfa_ipa_train'))
no_yknows <- subset(no_yknows, aligner %in% c('fave', 'maus', 'mfa_english', 'mfa_english_adapt', 'mfa_default_train', 
                                                          'mfa_english_ipa', 'mfa_english_ipa_adapt', 'mfa_ipa_train'))
