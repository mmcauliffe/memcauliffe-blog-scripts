...
class DummyArgs(object):
    def __init__(self):
        self.num_jobs = 12
        self.fast = False
        self.speaker_characters = 'prosodylab'
        self.verbose = False
        self.clean = True
...
if host == 'michael-laptop':
    ...
    output_directory = r'D:\Data\aligner_comp\phonsay\mfa_flat_lsa'
    dict_path = r'D:\Data\aligner_comp\dictionary.txt'
    temp_dir = r'D:\Data\aligner_comp\temp\MFA'
    model_path = r'D:\temp\english\english.zip'
    args.num_jobs = 6
elif host == 'roquefort':
...
def benchmark_align_corpus():
    beg = time.time()
    align_corpus(corpus_dir, dict_path, output_directory, temp_dir, None, args)
    end = time.time()
