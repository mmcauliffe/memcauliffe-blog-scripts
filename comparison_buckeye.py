...
base_dir = r'D:\Data\speech\benchmark_datasets\buckeye\aligner_comp'

reference_dir = r'D:\Data\speech\benchmark_datasets\buckeye\reference'

all_dirs = [x for x in os.listdir(base_dir)]

to_extract = [x for x in all_dirs if x not in ['reference', 'prosodylab_format']
              and os.path.isdir(os.path.join(base_dir, x))]
...
root_dir = r'D:\Data\speech\benchmark_datasets\buckeye\accuracy_data'
os.makedirs(root_dir, exist_ok=True)

def get_paths(identifier):
    words_distance_path = os.path.join(root_dir, f'{identifier}_word_distance.txt')
    phone_recall_path = os.path.join(root_dir, f'{identifier}_phone_recall.txt')
    phone_precision_path = os.path.join(root_dir, f'{identifier}_phone_precision.txt')
    ...
    return {'words_distance': words_distance_path,
            #'phone_recall': phone_recall_path,
            'utterance_metrics': utterance_metrics_path,
            #'phone_precision': phone_precision_path,
